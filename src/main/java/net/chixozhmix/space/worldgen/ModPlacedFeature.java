...
public class ModPlacedFeature {
    ...
    public static final ResourceKey<PlacedFeature> BIO_LANTERN_PLACED_KEY = resourceKey("lantern_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, BIO_LANTERN_PLACED_KEY,
                configuredFeatures.getOrThrow(ModConfiguredFeature.LANTERN_KEY),
                List.of(
                        CountPlacement.of(5), // Количество попыток на чанк
                        InSquarePlacement.spread(),
                        HeightRangePlacement.uniform(
                                VerticalAnchor.absolute(32), // Минимальная высота
                                VerticalAnchor.absolute(256) // Максимальная высота
