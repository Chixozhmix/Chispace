...
public class ModConfiguredFeature {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> LANTERN_KEY = registerKey("lantern_key");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?,?>> context) {
        ...
        register(context, FLESH_VINES_KEY,
                ChiSpace.FLESH_VINES.get(), // Используем RegistryObject
                NoneFeatureConfiguration.INSTANCE
        );

        register(context, GUTS_VINES_KEY,
        ...
        register(context, LANTERN_KEY,
                ChiSpace.BIO_LANTER.get(), // Используем RegistryObject
                NoneFeatureConfiguration.INSTANCE
        );
    }
