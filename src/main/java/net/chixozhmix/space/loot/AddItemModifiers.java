...
public class AddItemModifiers extends LootModifier {
    public static final Supplier<Codec<AddItemModifiers>> CODEC = Suppliers.memoize(() -> RecordCodecBuilder
            .create(inst -> codecStart(inst).and(ForgeRegistries.ITEMS.getCodec()
